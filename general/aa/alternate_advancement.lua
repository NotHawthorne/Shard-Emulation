        ...
        for k, v in pairs(AA.MainButtons) do
            ...
            Button:SetEvent("OnClick", function(self, event, Player)
				...
				elseif (v=="Defense") then
					cat = 2
				elseif (v=="Berserking") then
				    cat = 3
				elseif (v=="Companionship") then
					    cat = 4
				elseif (v=="Sharpshooting") then
						cat = 5
				elseif (v=="Shamanism") then
						cat = 6
				elseif (v=="Magicka") then
						cat = 7
				elseif (v=="Righteousness") then
						cat = 8
				elseif (v=="Blighting") then
						cat = 9
